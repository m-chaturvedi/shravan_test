...
def multilevelPWM(S=[-2,-1,0,1,2], sineharmonicnums=[1,3,5,7],
        sinevals=[1.5,0,0,0], cosineharmonicnums=[1,3,5,7],
        cosinevals=[0,0,0,0], N=2048, DCval=0, solver='ECOS', plots='OFF'):
    """
